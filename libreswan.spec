...
Version  : 4.5
Release  : 24
URL      : https://github.com/libreswan/libreswan/archive/v4.5/libreswan-4.5.tar.gz
Source0  : https://github.com/libreswan/libreswan/archive/v4.5/libreswan-4.5.tar.gz
...
%prep
%setup -q -n libreswan-4.5
cd %{_builddir}/libreswan-4.5
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630342407
...
cp %{_builddir}/libreswan-4.5/COPYING %{buildroot}/usr/share/package-licenses/libreswan/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/libreswan-4.5/LICENSE %{buildroot}/usr/share/package-licenses/libreswan/1877c44246850c068da2ffbba94330c9463f6552
cp %{_builddir}/libreswan-4.5/lib/COPYING.LIB %{buildroot}/usr/share/package-licenses/libreswan/ba8966e2473a9969bdcab3dc82274c817cfd98a1
cp %{_builddir}/libreswan-4.5/testing/linux-system-roles.vpn/LICENSE %{buildroot}/usr/share/package-licenses/libreswan/b4d3d28da251063ecef9aa630bbbdc9f9687677c
cp %{_builddir}/libreswan-4.5/testing/programs/getpeercon_server/LICENSE %{buildroot}/usr/share/package-licenses/libreswan/4cc77b90af91e615a64ae04893fdffa7939db84c
